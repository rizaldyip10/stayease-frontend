...
const UploadProofDialog: FC<UploadProofDialogProps> = ({ bookingId: propBookingId }) => {
    const router = useRouter();
    const searchParams = useSearchParams();
    const [file, setFile] = useState<File | null>(null);
    const [bookingId, setBookingId] = useState<string | null>(propBookingId || null);
        ...
        <Dialog>
            ...
            <DialogContent>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleUpload} disabled={!file} className="bg-blue-950">
                        Submit
                    </Button>
                </DialogFooter>
            </DialogContent>
